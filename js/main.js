...
//新手提醒~(tnd打不开超链接)
//function getCookie(cname){var name=cname+"=";var ca=document.cookie.split(';');for(var i=0;i<ca.length;i++){var c=ca[i].trim();if(c.indexOf(name)==0)return c.substring(name.length,c.length)}return""}var old=getCookie("old");setTimeout(function(){if(old!="yes"){document.cookie="old=yes";var notyf=new Notyf({duration:3500,position:{x:'center',y:'bottom',},dismissible:true,});notyf.success('嘿，新来的伙伴，要不看看<a helf="https:/blog.thun888.xyz/mustknow">站内须知</a>')}},4000);
//复制提醒
